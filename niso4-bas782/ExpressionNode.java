...
//        Math.sqrt(this.size) +
    ...
    public double evaluateOperator(double[] x, ArrayList<Double> args) {
        ...
        switch (this.root) {
            case "add":
                double ret = args.get(0) + args.get(1);
            ...
            case "mul":
                double retVal = args.get(0) * args.get(1);
            ...
            case "pow":
                double val = args.get(0) < 0 && args.get(1).intValue() != args.get(1) || args.get(0) == 0 ? 0 : Math.pow(args.get(0), args.get(1));
            ...
            case "exp":
                double exp = Math.exp(args.get(0));
            ...
            case "data":
                return x[((int) Math.abs(Math.floor(args.get(0)))) % n];
            case "diff":
                int i = ((int) Math.abs(Math.floor(args.get(0)))) % n;
                int j = ((int) Math.abs(Math.floor(args.get(1)))) % n;
                return x[i] - x[j];
            case "avg":
                int k = ((int) Math.abs(Math.floor(args.get(0)))) % n;
                int l = ((int) Math.abs(Math.floor(args.get(1)))) % n;
                if (k == l) return 0;
